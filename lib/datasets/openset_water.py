...
class openset_water(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, "water_openset_" + image_set)
        # print(self.name)
        # print('cehck!!')
        self._year = year
        self._image_set = image_set
        self._devkit_path = "/root/dataset/watercolor"
        ...
        self.private_class=( 'aeroplane',   'boat',
                    'bottle', 'bus',   'chair',
    ...
    def _do_python_eval(self, output_dir="output"):
        ...
        for i, cls in enumerate(self._classes):
            if cls == "__background__" or cls in self.private_class:
                continue
            filename = self._get_voc_results_file_template().format(cls)
            print(filename)
