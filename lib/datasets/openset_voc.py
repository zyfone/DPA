...
class openset_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None,altha=1.0):
        imdb.__init__(self, "voc_"+year +"_"+image_set+"_"+altha)
        self._year = year
        self._image_set = image_set
        self._devkit_path = "/root/dataset/VOCdevkit"
