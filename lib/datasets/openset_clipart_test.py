...
class openset_clipart_test(imdb):
    def __init__(self, image_set, devkit_path=None,altha=1.0):
        imdb.__init__(self, "clipart_" +image_set+"_"+altha)
        self._year = "2007"

        self._image_set = image_set
        self._devkit_path = "/root/dataset/clipart"
        ...
        if altha=="0.5":
            ...
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print("test mode")
            print("source domain private: aeroplane, bicycle, bird, boat, bottle")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            ...
            self._classes_private = ('aeroplane', 'bicycle', 'bird', 'boat', 'bottle')
                                    #  'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor') # uda source domain private
          
        elif altha=="0.75":
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print("test mode")
            print("source domain private: train, tvmonitor")
            print("common classes: boat,bottle,bus,car,cat,chair,cow,diningtable,dog,horse,motorbike,person,pottedplant,sheep,sofa")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            ...
            self._classes_private = ( "train", "tvmonitor",) #source domain private
        
        elif altha=="0.25":
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print("test mode")
            print("source domain private: bus,car,cat,chair,cow,diningtable,dog")
            print("common classes: plane bicycle bird boat bottle")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            ...
            self._classes_private = ("bus","car","cat","chair","cow","diningtable","dog") #source domain private
    ...
    def _do_python_eval(self, output_dir="output"):
        ...
        for i, cls in enumerate(self._classes):
            if cls == "__background__" or cls in self._classes_private:
                continue
            filename = self._get_voc_results_file_template().format(cls)
